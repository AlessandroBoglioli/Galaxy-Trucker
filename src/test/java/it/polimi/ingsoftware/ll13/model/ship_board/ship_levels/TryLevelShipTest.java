...
import it.polimi.ingsoftware.ll13.model.ship_board.ship_components.BatteryManager;
...
public class  TryLevelShipTest {
    private Ship ship;

    @BeforeEach
    void setUp() {
        ship = new TryLevelShip(PlayerColors.RED);
    }
    ...
    void testPlaceCabin_ShouldNotPlaceOutsideShip() {
        ...
        assertNull(ship.getShipLayout().getMotherBoard()[2][6].getTile());
    }
    ...
    void testCountFirePower_ShouldCountCorrectFirePower() {
        Tile tile1 = new CabinTile("", ConnectorType.SMOOTH, ConnectorType.SMOOTH, ConnectorType.SMOOTH ,ConnectorType.UNIVERSAL);
        Tile tile2 = new CannonTile("", ConnectorType.SINGLE, ConnectorType.DOUBLE, ConnectorType.UNIVERSAL,ConnectorType.SINGLE, Direction.TOP);
