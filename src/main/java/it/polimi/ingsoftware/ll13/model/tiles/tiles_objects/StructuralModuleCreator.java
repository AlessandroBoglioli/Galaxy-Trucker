...
/**
 * The {@code StructuralModuleCreator} class represents a "Structural Module" tile creator.
 * It is a factory concrete creator that creates {@link StructuralModuleTile} objects.
 * This tile represents a structural module of the ship and requires connector types for all four sides.
 * It extends the abstract class {@code TileCreator} and implements the specific properties of this tile type.
 *
 * @see TileCreator
 */
public class StructuralModuleCreator extends TileCreator {

    /**
     * Creates a new {@link StructuralModuleTile} object using the provided parameters.
     *
     ...
     * @return A new {@link StructuralModuleTile} object.
     * @throws IllegalArgumentException if the parameters are invalid or missing.
     * @throws org.json.JSONException if the JSON read contains errors.
     */
    @Override
    public Tile createTile(JSONObject data) throws IllegalArgumentException, JSONException {
        ...
        try {
            ...
            return new StructuralModuleTile(
                    image,
